...
const FEATURED = [
  {
    ...
    desc: "Full-stack coding interview platform on Vercel with real-time video calls, screen sharing, session recording and a collaborative multi-language code editor via Judge0. Inngest workflows and tight state/API tuning cut execution & session-update latency by 20%.",
    stack: ["React.js", "Node.js", "Express", "MongoDB", "Clerk", "Stream SDK", "Judge0", "Inngest"],
    glow: "var(--electric)",
  },
  {
    title: "Friend's Call",
    ...
    desc: "Real-time video communication platform with screen sharing and chat, deployed full-stack on Render. Automated room cleanup boosted session stability by 30%.",
    stack: ["React.js", "Node.js", "Express", "WebRTC", "Socket.IO", "MongoDB Atlas"],
    glow: "var(--neon)",
  },
  {
    ...
    icon: FileText,
    tag: "AI · OCR",
    desc: "AI-powered prescription analyzer supporting 4 image formats (JPG, JPEG, PNG, WebP) that extracts 5+ key medical attributes — patient info, medications, dosage, diagnosis, precautions — via OCR + Gemini. Integrates generic & branded medicine recommendations with pricing under a clean MVC architecture.",
    stack: ["React.js", "Tailwind CSS", "Gemini API", "OCR", "Vercel"],
    glow: "var(--neon)",
  },
  {
    ...
    icon: Boxes,
    tag: "Microservices",
    desc: "Distributed e-commerce backend with 6 Spring Boot microservices discovered via Netflix Eureka. Cross-service customer validation ensures orders only exist for registered customers, all fronted by Spring Cloud Gateway as a unified entry point.",
    stack: ["Java", "Spring Boot", "Spring Cloud", "Eureka", "MySQL", "React.js"],
    glow: "var(--electric)",
  },
];
